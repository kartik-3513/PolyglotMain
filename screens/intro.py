...
class MainPage(QMainWindow):
    def __init__(self):
        ...
        loadUi("Polyglot/screens/NEW_intro.ui", self)
        pixmap = QPixmap("Polyglot/screens/word-cloudedited.png")
        self.title_l.setPixmap(pixmap)
        self.start_sentence_b.clicked.connect(self.onClickMainVideo)
        self.start_sentence_b.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.start_upload_b.clicked.connect(self.onClickMainVideo)
